        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="w-9 h-9 rounded-full border border-[#D7E0D5] flex items-center justify-center text-[#233829] hover:bg-[#F3F6F1] transition-colors cursor-pointer active:scale-95"
            >
          ...
          <div className="lg:col-span-4 flex flex-col justify-between space-y-6">
            <div>
              ...
              <Link
                ...
                to="/contact"
                className="mt-4 inline-flex items-center gap-1.5 text-xs font-bold text-[#234530] hover:underline cursor-pointer"
              >
              ...
              <form onSubmit={handleSubscribe} className="mt-5 space-y-2.5">
                <div className="flex items-center bg-white/95 rounded-full p-1 pl-4 shadow-xs focus-within:ring-2 focus-within:ring-[#1E3E2A]/30">
                  <input
                    ...
                    disabled={subscribed}
                    className="w-full bg-transparent text-xs text-[#193623] placeholder-[#798C7E] focus:outline-hidden pr-2"
                    required
                  />
                  <button
                    ...
                    type="submit"
                    disabled={subscribed}
                    className={`shrink-0 flex items-center gap-1 text-[11px] sm:text-xs font-semibold px-4 py-2 rounded-full text-white transition-all cursor-pointer ${
                      subscribed
                        ? 'bg-[#183622]'
